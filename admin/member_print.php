                    ...
                    <table class="table table-striped col-2">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td ><center><?php echo $row["rg_name"]; ?></center></td>
                                <td ><center><?php echo $row["rg_surname"]; ?></center></td>
                                <td ><center><?php echo $row["rg_sex"]; ?></center></td>
                                <td ><center><?php echo $row["rg_birthday"]; ?></center></td>
                                <td ><center><?php echo $row["rg_weight"]; ?></center></td>
                                <td ><center><?php echo $row["rg_height"]; ?></center></td>
                                <td ><center><?php echo $row["rg_be_allergic"]; ?></center></td>
                                <td ><center><?php echo $row["rg_hp_ht"]; ?></center></td>
                                <td ><center><?php echo $row["rg_phone_patient"]; ?></center></td>
                                <td ><center><?php echo $row["rg_id_card"]; ?></center></td>
                                <td ><center><?php echo $row["rg_name_title_relative"]; ?></center></td>
                                <td ><center><?php echo $row["rg_name_relative"]; ?></center></td>
                                <td ><center><?php echo $row["rg_surname_relative"]; ?></center></td>
                                <td ><center><?php echo $row["rg_phong_relative"]; ?></center></td>
                            </tr>
